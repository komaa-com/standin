...
`@komaa/standin-sdk` is one end of a socket. StandIn handles the Microsoft Teams side and dials your
worker, once per call, over an authenticated WebSocket. This package answers that dial, speaks the
