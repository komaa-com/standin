...
|---|---|
| **StandIn** (hosted) | Handles the Microsoft Teams side. Dials your worker once per call. Places the reply audio back into the call. |
...
a sample of what the caller hears.
</Note>
